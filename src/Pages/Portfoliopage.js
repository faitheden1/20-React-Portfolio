        ...
        <div className="main">
            ...
            <div className="row">
                <div className="column0">
                    <div className="content">
                        <h2>Projects and Linkedin</h2>
                        <p>Here are several examples of projects I worked on in UC Berkeley Bootcamp</p>
                    </div>
                </div>
            ...
            <div className="row">
                <div className="column1">
                    <div className="content">
                        <h1>Burger</h1>
                        <p>link to deployed version <a href="  https://faitheden1.github.io/burger/">here</a>.</p>
                        <p>link to deployed GitHub Repository <a href=" https://github.com/faitheden1/burger.git">here</a>.</p>
                    </div>
                </div>
            </div>
            ...
            <div className="row">
                <div className="column1">
                    <div className="content">
                        <h1>Day Planner</h1>
                        <p>link to deployed version <a href=" https://faitheden1.github.io/Day-Planner/">here</a>.</p>
                        <p>link to deployed GitHub Repository <a href=" https://github.com/faitheden1/Day-Planner.git">here</a>.</p>
                    </div>
                </div>
